...
import { sampleWithRequiredData } from '../asset-register.test-samples';
...
describe('AssetRegister Management Component', () => {
  let comp: AssetRegisterComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AssetRegisterComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.assetRegisters()[0]).toEqual(expect.objectContaining({ id: 25580 }));
  });

  describe('trackId', () => {
    it('should forward to assetRegisterService', () => {
      const entity = { id: 25580 };
      jest.spyOn(service, 'getAssetRegisterIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAssetRegisterIdentifier).toHaveBeenCalledWith(entity);
