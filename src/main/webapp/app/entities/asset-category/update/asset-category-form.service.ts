...
type AssetCategoryFormDefaults = Pick<NewAssetCategory, 'id' | 'isActive' | 'createdDate' | 'lastModifiedDate'>;

type AssetCategoryFormGroupContent = {
  id: FormControl<AssetCategoryFormRawValue['id'] | NewAssetCategory['id']>;
  branchCode: FormControl<AssetCategoryFormRawValue['branchCode']>;
  branchId: FormControl<AssetCategoryFormRawValue['branchId']>;
  ...
  isActive: FormControl<AssetCategoryFormRawValue['isActive']>;
...
export class AssetCategoryFormService {
  createAssetCategoryFormGroup(assetCategory: AssetCategoryFormGroupInput = { id: null }): AssetCategoryFormGroup {
    ...
    return new FormGroup<AssetCategoryFormGroupContent>({
      ...
      branchCode: new FormControl(assetCategoryRawValue.branchCode),
      branchId: new FormControl(assetCategoryRawValue.branchId),
      ...
      isActive: new FormControl(assetCategoryRawValue.isActive),
