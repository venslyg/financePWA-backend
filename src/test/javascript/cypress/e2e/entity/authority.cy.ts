...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '340f01c1-979c-4904-9727-f14e211abe2c' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('b2378449-ae96-477a-b33d-929d892d2b0f');
      cy.get(`[data-cy="name"]`).should('have.value', 'b2378449-ae96-477a-b33d-929d892d2b0f');
